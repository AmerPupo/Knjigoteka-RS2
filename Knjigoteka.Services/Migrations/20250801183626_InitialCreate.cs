        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuantityForBorrow = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    QuantityForSale = table.Column<int>(type: "int", nullable: false, defaultValue: 0)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookBranches", x => new { x.BookId, x.BranchId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Borrowings_Branches_BranchId",
                        column: x => x.BranchId,
                        principalTable: "Branches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_NotificationRequests_Branches_BranchId",
                        column: x => x.BranchId,
                        principalTable: "Branches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RestockRequests_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RestockRequests_Branches_BranchId",
                        column: x => x.BranchId,
                        principalTable: "Branches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RestockRequests_Employees_EmployeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NotificationRequests_BookId",
                table: "NotificationRequests",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_NotificationRequests_BranchId",
                table: "NotificationRequests",
                column: "BranchId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RestockRequests_BookId",
                table: "RestockRequests",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_RestockRequests_BranchId",
                table: "RestockRequests",
                column: "BranchId");

            migrationBuilder.CreateIndex(
                name: "IX_RestockRequests_EmployeeId",
                table: "RestockRequests",
                column: "EmployeeId");
